...
local_server=True
app=Flask(__name__)
app.secret_key='something-personal'
app.config.update(
    MAIL_SERVER="smtp.gmail.com",
    MAIL_PORT='465',
    MAIL_USE_SSL=True,
    MAIL_USERNAME=params['email_uri'],
    MAIL_PASSWORD=params['pass_uri']
)
...
def contact():
    if (request.method=='POST'):
        ...
        mail.send_message('New message from '+name,
                          sender=email, recipients=[params['email_uri']],
                          body=message+"\n"+phone
                          )
